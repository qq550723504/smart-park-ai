...
const navItems = computed<WorkbenchNavItem[]>(() => [
  ...
  { value: 'operations', label: '运营看板', available: ['VIEWER', 'OPERATOR', 'APPROVER', 'ADMIN'].includes(role.value)
    && (capabilities.value?.analyticsEnabled === true || ['OPERATOR', 'ADMIN'].includes(role.value)) },

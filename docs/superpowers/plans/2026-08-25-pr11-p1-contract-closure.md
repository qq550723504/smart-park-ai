...
**Goal:** Close the six P1 findings created against `f5b36f51b5` by making SQL, result-summary, expert-synthesis, and database privilege contracts complete and lossless.
...
### Task 5: Full verification and GitHub review closure
...
Use GitHub GraphQL `reviewThreads(first:100)` and confirm the six targeted thread IDs are still current and unresolved. Re-evaluate any newly added P1 before pushing; do not resolve outdated or unrelated comments by assumption.
...
- [ ] **Step 4: Reply and resolve the six original threads**
